...
// generateRandomCode provides a mock function with given fields:
func (_m *MockService) generateRandomCode() string {
	ret := _m.Called()
...
// sendEmail provides a mock function with given fields: toEmail, code
func (_m *MockService) sendEmail(toEmail string, code string) error {
	ret := _m.Called(toEmail, code)
