...
// GetUsersRole provides a mock function with given fields: ctx, userID
func (_m *MockService) GetUsersRole(ctx context.Context, userID int) ([]models.UsuarioRol, error) {
	ret := _m.Called(ctx, userID)

	var r0 []models.UsuarioRol
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) ([]models.UsuarioRol, error)); ok {
		return rf(ctx, userID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int) []models.UsuarioRol); ok {
		r0 = rf(ctx, userID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.UsuarioRol)
		}
	}
