...
async function getDocumentos() {
    ...
    const request = await fetch("http://34.192.187.56:5000/pisos/" + obraid, {
        method: 'GET',
    })
    ...
    const request2 = await fetch("http://34.192.187.56:5000/document/" + obraid, {
        method: 'GET',
    })
...
async function eliminarDocumento(id){
    ...
    const request = await fetch("http://34.192.187.56:5000/document/eliminar/"+ id, {
               method: 'DELETE',
               headers: {
